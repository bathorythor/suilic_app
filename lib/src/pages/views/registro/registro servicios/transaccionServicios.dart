...
import 'package:suilic_app/src/pages/views/registro/registro%20servicios/pagoServicios.dart';

import '../registro general/Transacciones_general.dart';

class TransaccionesServicios extends StatelessWidget {
  const TransaccionesServicios({super.key});
              ...
              child: ElevatedButton(
                  onPressed: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => const PagoServicios()));
                  },
